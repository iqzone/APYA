 ...
 * Minify_Source
 */
require_once 'Minify/Source.php';/*noLibHook*/
...
class Minify {
    ...
    {
        if (is_string($cache)) {
            require_once 'Minify/Cache/File.php';/*noLibHook*/
    ...
    public static function serve($controller, $options = array())
    {
        if (is_string($controller)) {
            ...
            if (! class_exists($class, false)) {
                require_once "Minify/Controller/" 
                    . str_replace('_', '/', $controller) . ".php";/*noLibHook*/
            }
        ...
        if (self::$_options['encodeOutput']) {
            if (self::$_options['encodeMethod'] !== null) {
                ...
                require_once 'HTTP/Encoder.php';/*noLibHook*/
        ...
        // check client cache
        require_once 'HTTP/ConditionalGet.php';/*noLibHook*/
        $cgOptions = array(
        ...
        if (null !== self::$_cache) {
            ...
            // memory.
            $cacheId = 'minify_' . self::_getCacheId();/*noLibHook*/
    ...
    public static function setDocRoot($unsetPathInfo = false)
    {
        if (isset($_SERVER['SERVER_SOFTWARE'])
            ...
            require_once 'Minify/Logger.php';/*noLibHook*/
    ...
    protected static function _combineMinify()
    {
        ...
        if (self::$_options['postprocessorRequire']) {
            require_once self::$_options['postprocessorRequire'];/*noLibHook*/
        }
