...
<script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#pubid=xa-4f38dbd865c1cfe2"></script>
<style>
html, body {
	overflow: hidden;
	width: 500px;
...
<div id="wrapper">
	...
	<a class="addthis_button_pinterest" style="margin-top:5px"></a>
