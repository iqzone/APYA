        ...
        return {
			...
			init: function (id) {
				...
				if (currenttime-lastcall > 10) {
					...
					loadCCPopup(baseUrl+'plugins/writeboard/index.php?action=writeboard&type=1&id='+random+'&basedata='+baseData, 'writeboard',"status=0,toolbar=0,menubar=0,directories=0,resizable=1,location=0,status=0,scrollbars=0, width=640,height=480",640,480,'<?php echo $writeboard_language[7];?>',1);
			...
			accept: function (id,random) {
				...
				loadCCPopup(baseUrl+'plugins/writeboard/index.php?action=writeboard&type=0&id='+random+'&basedata='+baseData, 'writeboard',"status=0,toolbar=0,menubar=0,directories=0,resizable=1,location=0,status=0,scrollbars=0, width=640,height=480",640,480,'<?php echo $writeboard_language[7];?>',1);
			}
        };
    })();
