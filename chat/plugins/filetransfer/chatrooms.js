...
(function($){   
	...
	$.ccfiletransfer = (function () {
        ...
        return {
			...
			init: function (id) {
				baseUrl = getBaseUrl();
				loadCCPopup(baseUrl+'plugins/filetransfer/index.php?chatroommode=1&id='+id, 'filetransfer',"status=0,toolbar=0,menubar=0,directories=0,resizable=0,location=0,status=0,scrollbars=0, width=400,height=140",400,130,'<?php echo $filetransfer_language[1];?>'); 
			}
