	...
	$.ccjabber = (function () {
        ...
        return {
			...
			login: function () {
				...
				loadCCPopup(baseUrl+'extensions/jabber/index.php?basedata='+baseData+'&basedomain='+baseDomain, 'jabber',"status=0,toolbar=0,menubar=0,directories=0,resizable=0,location=0,status=0,scrollbars=0, width=480,height=185",480,150,'<?php echo $connectPhrase;?> <?php echo $jabber_language[15];?>'); 
			...
			getFriendsList: function (first) {
				$.getJSON(server+session+"?json_callback=?", {'action':'getOnlineBuddies', md5: hash} , function(data){
