...
class Sabre_DAV_Server {
    ...
    protected function httpMkcol($uri) {
        ...
        if ($requestBody) {
            ...
            if (!isset($properties['{DAV:}resourcetype'])) 
                throw new Sabre_DAV_Exception_BadRequest('The mkcol request must include a {DAV:}resourcetype property');/*noLibHook*/
    ...
    public function createCollection($uri, array $resourceType, array $properties) {
        ...
        if (!in_array('{DAV:}collection', $resourceType)) {
            throw new Sabre_DAV_Exception_InvalidResourceType('The resourceType for this collection must at least include {DAV:}collection');/*noLibHook*/
        }
