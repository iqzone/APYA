...
$this->_funcHooks['settingsForm'] = array('viewlevelloop','isCreating','hasError','alloweditors','allowprivateclub','islocal','isremote','localhiddensetting','allowcreate','allowguests','allowguestcomments','disablecomments','trackcomments','localblog','allowrss','rssallowed','ping_services','allowtrackbacks','approvetrackbacks','selectskin','listview','groupperdate','grouppermonth','xmlrpcenabled');
...
{
$count_40fe123ff4ea313774bc5f3005133bb7 = is_array($this->functionData['create2']) ? count($this->functionData['create2']) : 0;
$this->functionData['create2'][$count_40fe123ff4ea313774bc5f3005133bb7]['blog'] = $blog;
$this->functionData['create2'][$count_40fe123ff4ea313774bc5f3005133bb7]['errors'] = $errors;
}
...
{
$count_1d2b07f7b177edfdd00e0775ea1c32ab = is_array($this->functionData['listCategories']) ? count($this->functionData['listCategories']) : 0;
$this->functionData['listCategories'][$count_1d2b07f7b177edfdd00e0775ea1c32ab]['blog'] = $blog;
}
	...
	<table class=\"ipb_table\">
		<tr class=\"header\">
			...
			<th class='col_mod'></th>
				...
				".$this->__f__20a879dc5e95c2798614e82d152f28fc($blog)."	</table>
...
function __f__20a879dc5e95c2798614e82d152f28fc($blog=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b85baf7feb4d8802e9a37eef6085c9ce = is_array($this->functionData['manageComments']) ? count($this->functionData['manageComments']) : 0;
$this->functionData['manageComments'][$count_b85baf7feb4d8802e9a37eef6085c9ce]['comments'] = $comments;
$this->functionData['manageComments'][$count_b85baf7feb4d8802e9a37eef6085c9ce]['blog'] = $blog;
$this->functionData['manageComments'][$count_b85baf7feb4d8802e9a37eef6085c9ce]['pagination'] = $pagination;
}
...
" . ((is_array( $comments ) && count( $comments )) ? ("<div class='ipsBox'>
		".$this->__f__8aa197a4cab0ef67bdcb47c9dd1aeae0($comments,$blog,$pagination)."	</div>
	" . (($this->memberData['g_blog_allowownmod']) ? ("
			<div class='bar altbar moderation_bar with_action'>
...
function __f__8aa197a4cab0ef67bdcb47c9dd1aeae0($comments, $blog, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d738e361b55fcaa4e39f42d0986a877f = is_array($this->functionData['manageDashboard']) ? count($this->functionData['manageDashboard']) : 0;
$this->functionData['manageDashboard'][$count_d738e361b55fcaa4e39f42d0986a877f]['myBlogs'] = $myBlogs;
$this->functionData['manageDashboard'][$count_d738e361b55fcaa4e39f42d0986a877f]['latestComments'] = $latestComments;
$this->functionData['manageDashboard'][$count_d738e361b55fcaa4e39f42d0986a877f]['error'] = $error;
$this->functionData['manageDashboard'][$count_d738e361b55fcaa4e39f42d0986a877f]['dropdown'] = $dropdown;
}
...
<div class='ipsLayout " . ((is_array( $latestComments ) && count( $latestComments )) ? ("ipsLayout_withright ipsLayout_bigright") : ("")) . " clearfix'>
		...
		<table class='ipb_table' summary=\"{$this->lang->words['your_current_blogs']}\">
			<tr class='header'>
				...
				<th scope='col' class='short' width=\"10%\">{$this->lang->words['your_blogs_comments']}</th>
						...
						".$this->__f__5882c7525e6bef469e003901f0045529($myBlogs,$latestComments,$error,$dropdown)."		</table>
		<br />
	</div>
	" . ((is_array( $latestComments ) && count( $latestComments )) ? ("<div class='ipsLayout_right'>
			...
			<div class='ipsBox'>
				".$this->__f__8948d6fd088e03492ba0bff718a2e1a9($myBlogs,$latestComments,$error,$dropdown)."			</div>
...
function __f__5882c7525e6bef469e003901f0045529($myBlogs=array(), $latestComments=array(), $error='', $dropdown='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8948d6fd088e03492ba0bff718a2e1a9($myBlogs=array(), $latestComments=array(), $error='', $dropdown='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_287ca96ecaf2d58103ffb6556522f987 = is_array($this->functionData['rssImportForm']) ? count($this->functionData['rssImportForm']) : 0;
$this->functionData['rssImportForm'][$count_287ca96ecaf2d58103ffb6556522f987]['blog'] = $blog;
$this->functionData['rssImportForm'][$count_287ca96ecaf2d58103ffb6556522f987]['data'] = $data;
$this->functionData['rssImportForm'][$count_287ca96ecaf2d58103ffb6556522f987]['error'] = $error;
$this->functionData['rssImportForm'][$count_287ca96ecaf2d58103ffb6556522f987]['tagBox'] = $tagBox;
}
				...
				<li class='ipsField ipsField_select'>
					...
					<p class='ipsField_content'>
						<select name='rss_cats[]' id='rss_cats' multiple='true' size='5'>
							" . ((is_array($data['_cats']) AND count($data['_cats'])) ? ("".$this->__f__42151ad1231ce285ab208fde2e0c6802($blog,$data,$error,$tagBox)."							") : ("")) . "
						</select>
...
function __f__42151ad1231ce285ab208fde2e0c6802($blog, $data, $error, $tagBox)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c5c25fee70571f7dd90751721cc11050 = is_array($this->functionData['settingsForm']) ? count($this->functionData['settingsForm']) : 0;
$this->functionData['settingsForm'][$count_c5c25fee70571f7dd90751721cc11050]['blog'] = $blog;
$this->functionData['settingsForm'][$count_c5c25fee70571f7dd90751721cc11050]['error'] = $error;
}
$IPBHTML .= "<script type=\"text/javascript\">
					...
					<table class=\"ipb_table\">
						...
						<tr class=\"row1\">
							<td valign=\"top\">
								...
								<ul>
									...
									" . (($this->memberData['g_blog_allowcreate'] AND $this->memberData['g_blog_allowlocal']) ? ("<li class='field' style='display:none'>
										...
										</li>") : ("" . (($this->memberData['g_blog_allowlocal']) ? ("
									...
									<li class='field' id='list_blog_view_level'>
										...
										<select class='input_select blogform' name='blog_view_level' id='blog_view_level'>
											".$this->__f__6b2364b0615d09522ecf87162f438ed0($blog,$error)."										</select>
									</li>
								</ul>
								</fieldset>
							</td>
							<td valign=\"top\">
								...
								" . (($this->memberData['g_blog_allowlocal']) ? ("<fieldset id='blog_local_settings' " . (($blog['blog_type'] == 'external') ? ("style='display: none'") : ("")) . ">	
										<ul>
					...
					<tr class=\"row1\">
						<td valign=\"top\">
							...
							<fieldset>
								...
								<ul>
								".$this->__f__fda8217940f08e2e03452f3b14860c0d($blog,$error)."								</ul>
							</fieldset>
							") : ("
...
function __f__6b2364b0615d09522ecf87162f438ed0($blog, $error='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__fda8217940f08e2e03452f3b14860c0d($blog, $error='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
