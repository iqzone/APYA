...
$this->_funcHooks['uploadForm'] = array('flashuploadhelp','uploadformhelp');
...
{
$count_282ad612aba4bdca1eefbee3af83b644 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_282ad612aba4bdca1eefbee3af83b644]['data'] = $data;
}
...
{
$count_4d432ff9c9b3b161517c75d1465653fa = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_4d432ff9c9b3b161517c75d1465653fa]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_4d432ff9c9b3b161517c75d1465653fa]['form'] = $form;
}
...
{
$count_8f49efe665084f05995160b3c37c0f14 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_8f49efe665084f05995160b3c37c0f14]['data'] = $data;
}
...
{
$count_b48f7e13f1f41643bc020f380cdb1b3c = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_b48f7e13f1f41643bc020f380cdb1b3c]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__65eb89d94ef7fd81d9bc8d3f8277e93a($posts)."") : ("")) . "
<p class='submit'>
...
function __f__65eb89d94ef7fd81d9bc8d3f8277e93a($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $posts as $pid => $data )
	{
		...
		<div class='post_block topic_summary'>
			" . (($data['member_id']) ? ("
				<h3><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showuser={$data['member_id']}", "public",'' ), "{$data['members_seo_name']}", "showuser" ) . "'>{$data['author']}</a></h3>
			") : ("
				<h3>{$data['author']}</h3>
			")) . "
...
{
$count_719815b1148ddbbd92350c359ec0bb8f = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_719815b1148ddbbd92350c359ec0bb8f]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_719815b1148ddbbd92350c359ec0bb8f]['type'] = $type;
$this->functionData['uploadForm'][$count_719815b1148ddbbd92350c359ec0bb8f]['stats'] = $stats;
$this->functionData['uploadForm'][$count_719815b1148ddbbd92350c359ec0bb8f]['id'] = $id;
$this->functionData['uploadForm'][$count_719815b1148ddbbd92350c359ec0bb8f]['forum_id'] = $forum_id;
}
