...
{
$count_1f753e9a5526b9d8de4af573398f1353 = is_array($this->functionData['deletedPosts']) ? count($this->functionData['deletedPosts']) : 0;
$this->functionData['deletedPosts'][$count_1f753e9a5526b9d8de4af573398f1353]['posts'] = $posts;
$this->functionData['deletedPosts'][$count_1f753e9a5526b9d8de4af573398f1353]['other_data'] = $other_data;
$this->functionData['deletedPosts'][$count_1f753e9a5526b9d8de4af573398f1353]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts'>
			".$this->__f__a72f3a7469be0ef1d68730317137d6df($posts,$other_data,$pagelinks)."		</div>
	") : ("
...
function __f__a72f3a7469be0ef1d68730317137d6df($posts, $other_data=array(), $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8d7c2416d2803684abb26f5aa48ea9bd = is_array($this->functionData['deletedTopics']) ? count($this->functionData['deletedTopics']) : 0;
$this->functionData['deletedTopics'][$count_8d7c2416d2803684abb26f5aa48ea9bd]['topics'] = $topics;
$this->functionData['deletedTopics'][$count_8d7c2416d2803684abb26f5aa48ea9bd]['sdelete'] = $sdelete;
$this->functionData['deletedTopics'][$count_8d7c2416d2803684abb26f5aa48ea9bd]['pagelinks'] = $pagelinks;
}
...
{
$count_fcd7fbd23f3126bd3b15e14cbf7264f2 = is_array($this->functionData['editUserForm']) ? count($this->functionData['editUserForm']) : 0;
$this->functionData['editUserForm'][$count_fcd7fbd23f3126bd3b15e14cbf7264f2]['profile'] = $profile;
$this->functionData['editUserForm'][$count_fcd7fbd23f3126bd3b15e14cbf7264f2]['custom_fields'] = $custom_fields;
}
	...
	<fieldset>
		...
		" . ((count($custom_fields->out_fields)) ? ("
			...
			<ul class='ipsForm ipsForm_horizontal'>
				...
				".$this->__f__005e26af5b05d0860d0e09e371410647($profile,$custom_fields)."			</ul>
		") : ("")) . "
...
function __f__005e26af5b05d0860d0e09e371410647($profile, $custom_fields=null)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8172ed364745e9481a0a248b867d9650 = is_array($this->functionData['latestWarnLogs']) ? count($this->functionData['latestWarnLogs']) : 0;
$this->functionData['latestWarnLogs'][$count_8172ed364745e9481a0a248b867d9650]['warnings'] = $warnings;
$this->functionData['latestWarnLogs'][$count_8172ed364745e9481a0a248b867d9650]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	<table class='ipb_table'>
		...
		" . ((is_array( $warnings ) AND count( $warnings )) ? ("
						".$this->__f__b3bcb923192e1e80013dba847073ca6b($warnings,$pagelinks)."		") : ("
			<tr>
...
function __f__b3bcb923192e1e80013dba847073ca6b($warnings, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_cf12b7087bc73940a8dafc104f334a44 = is_array($this->functionData['memberLookup']) ? count($this->functionData['memberLookup']) : 0;
}
...
{
$count_a6c20ce6e188b57e0d135d04b2e87f7b = is_array($this->functionData['membersList']) ? count($this->functionData['membersList']) : 0;
$this->functionData['membersList'][$count_a6c20ce6e188b57e0d135d04b2e87f7b]['type'] = $type;
$this->functionData['membersList'][$count_a6c20ce6e188b57e0d135d04b2e87f7b]['members'] = $members;
$this->functionData['membersList'][$count_a6c20ce6e188b57e0d135d04b2e87f7b]['pagelinks'] = $pagelinks;
}
		...
		<div id='member_wrap'>
			<ul class='ipsMemberList'>
				" . ((is_array( $members ) and count( $members )) ? ("
										".$this->__f__e7e2b6515baa0606f94fb3f1fa08e101($type,$members,$pagelinks)."				") : ("
...
function __f__e7e2b6515baa0606f94fb3f1fa08e101($type, $members, $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_20e9762b418afb7fe3fa3d465e6053ac = is_array($this->functionData['membersModIPForm']) ? count($this->functionData['membersModIPForm']) : 0;
$this->functionData['membersModIPForm'][$count_20e9762b418afb7fe3fa3d465e6053ac]['ip'] = $ip;
$this->functionData['membersModIPForm'][$count_20e9762b418afb7fe3fa3d465e6053ac]['inlineMsg'] = $inlineMsg;
}
...
{
$count_7d8e7d29416d15d72ec0bcc1fbe527e1 = is_array($this->functionData['membersModIPFormMembers']) ? count($this->functionData['membersModIPFormMembers']) : 0;
$this->functionData['membersModIPFormMembers'][$count_7d8e7d29416d15d72ec0bcc1fbe527e1]['pages'] = $pages;
$this->functionData['membersModIPFormMembers'][$count_7d8e7d29416d15d72ec0bcc1fbe527e1]['members'] = $members;
}
...
<table class='ipb_table'>
	...
	" . ((is_array( $members ) AND count( $members )) ? ("
				".$this->__f__5d71cf180dea6299f9a9a77f30227314($pages,$members)."	") : ("")) . "
</table>
<br />
...
function __f__5d71cf180dea6299f9a9a77f30227314($pages="",$members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_956f19798fcc1cbe5eabd7e3b752a9ff = is_array($this->functionData['membersModIPFormPosts']) ? count($this->functionData['membersModIPFormPosts']) : 0;
$this->functionData['membersModIPFormPosts'][$count_956f19798fcc1cbe5eabd7e3b752a9ff]['count'] = $count;
$this->functionData['membersModIPFormPosts'][$count_956f19798fcc1cbe5eabd7e3b752a9ff]['pageLinks'] = $pageLinks;
$this->functionData['membersModIPFormPosts'][$count_956f19798fcc1cbe5eabd7e3b752a9ff]['results'] = $results;
}
...
<br />
" . ((count($results)) ? ("
		".$this->__f__658ba92c68c697109187d935379c1974($count,$pageLinks,$results)."") : ("")) . "
<br />
<div class='topic_controls'>
	{$pageLinks}
</div>";
...
function __f__658ba92c68c697109187d935379c1974($count=0, $pageLinks='', $results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_42bb9e81ef30fd0a96fff237c508047e = is_array($this->functionData['modAnnounceForm']) ? count($this->functionData['modAnnounceForm']) : 0;
$this->functionData['modAnnounceForm'][$count_42bb9e81ef30fd0a96fff237c508047e]['announce'] = $announce;
$this->functionData['modAnnounceForm'][$count_42bb9e81ef30fd0a96fff237c508047e]['forum_html'] = $forum_html;
$this->functionData['modAnnounceForm'][$count_42bb9e81ef30fd0a96fff237c508047e]['type'] = $type;
$this->functionData['modAnnounceForm'][$count_42bb9e81ef30fd0a96fff237c508047e]['editor_html'] = $editor_html;
$this->functionData['modAnnounceForm'][$count_42bb9e81ef30fd0a96fff237c508047e]['msg'] = $msg;
}
...
{
$count_1aee599d61d1e2bbe8c8a60156503e96 = is_array($this->functionData['modAnnouncements']) ? count($this->functionData['modAnnouncements']) : 0;
$this->functionData['modAnnouncements'][$count_1aee599d61d1e2bbe8c8a60156503e96]['announcements'] = $announcements;
}
...
<div class='topic_buttons'>
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_announcements']}\">
		...
		" . ((is_array( $announcements ) AND count( $announcements )) ? ("
						".$this->__f__f64a124a0557347e4e45c547b944960f($announcements)."		") : ("
			<tr>
...
function __f__abc4d30bb93e9730dda56763d95227cc($announcements,$announce='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f64a124a0557347e4e45c547b944960f($announcements)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
				...
				<tr class=\"" .  IPSLib::next( $this->registry->templateStriping["announcements"] ) . " " . ((!$announce['announce_active']) ? ("moderated") : ("")) . "\">
					...
					<td>
						<div class=\"forumdesc\">
							...
							") : ("" . ((is_array( $announce['_forums'] ) and count( $announce['_forums'] )) ? ("
									<ul>
									".$this->__f__abc4d30bb93e9730dda56763d95227cc($announcements,$announce)."									</ul>
								") : ("
					...
					<td class=\"short\">
						<ul class='ipsList_inline ipsList_nowrap'>
							...
							<li>
								<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=modcp&amp;tab=announcements&amp;fromapp=forums&amp;_do=delete&amp;announce_id={$announce['announce_id']}&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" id=\"del_{$announce['announce_id']}\" class='ipsButton_secondary'>{$this->lang->words['announce_delete']}</a>
							</li>
						</ul>
						<script type='text/javascript'>
...
{
$count_f9c9d45816d99d5c87d24b14fe15abf4 = is_array($this->functionData['modcpMessage']) ? count($this->functionData['modcpMessage']) : 0;
$this->functionData['modcpMessage'][$count_f9c9d45816d99d5c87d24b14fe15abf4]['message'] = $message;
}
...
{
$count_faad31f58edd42a4c4aec930aeeed74d = is_array($this->functionData['modCPpost']) ? count($this->functionData['modCPpost']) : 0;
$this->functionData['modCPpost'][$count_faad31f58edd42a4c4aec930aeeed74d]['post'] = $post;
$this->functionData['modCPpost'][$count_faad31f58edd42a4c4aec930aeeed74d]['displayData'] = $displayData;
$this->functionData['modCPpost'][$count_faad31f58edd42a4c4aec930aeeed74d]['topic'] = $topic;
$this->functionData['modCPpost'][$count_faad31f58edd42a4c4aec930aeeed74d]['type'] = $type;
}
...
{
$count_7f7ba377eaaf2909c404659a044235d2 = is_array($this->functionData['modCPtopic']) ? count($this->functionData['modCPtopic']) : 0;
$this->functionData['modCPtopic'][$count_7f7ba377eaaf2909c404659a044235d2]['topics'] = $topics;
$this->functionData['modCPtopic'][$count_7f7ba377eaaf2909c404659a044235d2]['pagelinks'] = $pagelinks;
$this->functionData['modCPtopic'][$count_7f7ba377eaaf2909c404659a044235d2]['type'] = $type;
$this->functionData['modCPtopic'][$count_7f7ba377eaaf2909c404659a044235d2]['sdelete'] = $sdelete;
}
$IPBHTML .= "".$this->__f__ff95c9bcb7fe3c4d91c81ed7a66aabcd($topics,$pagelinks,$type,$sdelete)."";
return $IPBHTML;
}


function __f__993a9272e2ac4af8c96e1f964e3f7f2e($topics, $pagelinks, $type, $sdelete=array(),$tid='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ff95c9bcb7fe3c4d91c81ed7a66aabcd($topics, $pagelinks, $type, $sdelete=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	<tr class='__topic' id='trow_{$data['tid']}' data-tid=\"{$data['tid']}\">
		<td class='__tid{$data['tid']} with_mod_links'>	
			...
			" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
				...
				".$this->__f__993a9272e2ac4af8c96e1f964e3f7f2e($topics,$pagelinks,$type,$sdelete,$tid,$data)."				</ul>
			") : ("")) . "
			<br />
...
{
$count_c431a5a730535ee9661a3343b29fc146 = is_array($this->functionData['portalPage']) ? count($this->functionData['portalPage']) : 0;
$this->functionData['portalPage'][$count_c431a5a730535ee9661a3343b29fc146]['output'] = $output;
$this->functionData['portalPage'][$count_c431a5a730535ee9661a3343b29fc146]['tabs'] = $tabs;
$this->functionData['portalPage'][$count_c431a5a730535ee9661a3343b29fc146]['_activeNav'] = $_activeNav;
}
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='modcp_tabs'>
			<ul class='clear'>
				...
				".$this->__f__0620313a2d8e022ecb50ddb126955f1e($output,$tabs,$_activeNav)."			</ul>
		</div>
...
function __f__0620313a2d8e022ecb50ddb126955f1e($output, $tabs=array(), $_activeNav=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ae51ea27144a860f9110106651bc9107 = is_array($this->functionData['subTabLoop']) ? count($this->functionData['subTabLoop']) : 0;
}
$IPBHTML .= "".$this->__f__dc782e67346fc82b625a413497bf822e()."";
return $IPBHTML;
}


function __f__77d6da0451c72385c69764f795761ec6($mainTabKey='',$subTabs='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__dc782e67346fc82b625a413497bf822e()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	" . (($mainTabKey == $this->templateVars['activeNav']['primary']) ? ("" . ((count( $subTabs ) > 1) ? ("
			<div class='maintitle ipsFilterbar clear'>
				<ul class='ipsList_inline'>									
					".$this->__f__77d6da0451c72385c69764f795761ec6($mainTabKey,$subTabs)."				</ul>
			</div>
		") : ("")) . "") : ("")) . "
...
{
$count_d6ccc4d47c22c367382ab3c212da13fb = is_array($this->functionData['unapprovedPosts']) ? count($this->functionData['unapprovedPosts']) : 0;
$this->functionData['unapprovedPosts'][$count_d6ccc4d47c22c367382ab3c212da13fb]['posts'] = $posts;
$this->functionData['unapprovedPosts'][$count_d6ccc4d47c22c367382ab3c212da13fb]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("topic", "0" ) . "
" . ((!$this->settings['disable_lightbox']) ? ("
" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'include_lightbox' ) ? $this->registry->getClass('output')->getTemplate('global')->include_lightbox() : '' ) . "
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts2'>
			".$this->__f__4612242e2c2ff014995cc795c1038018($posts,$pagelinks)."		</div>
	") : ("
		<div class='no_messages'>
...
function __f__4612242e2c2ff014995cc795c1038018($posts, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $posts as $post )
...
{
$count_7b34ecf567b4721ac436d8a864b4e131 = is_array($this->functionData['unapprovedTopics']) ? count($this->functionData['unapprovedTopics']) : 0;
$this->functionData['unapprovedTopics'][$count_7b34ecf567b4721ac436d8a864b4e131]['topics'] = $topics;
$this->functionData['unapprovedTopics'][$count_7b34ecf567b4721ac436d8a864b4e131]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("forums", "0" ) . "
<div>{$pagelinks}</div>
" . ( method_exists( $this->registry->getClass('output')->getTemplate('modcp'), 'subTabLoop' ) ? $this->registry->getClass('output')->getTemplate('modcp')->subTabLoop() : '' ) . "
