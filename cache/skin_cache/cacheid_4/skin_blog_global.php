...
/* CACHE FILE: Generated: Fri, 21 Sep 2012 00:18:48 GMT */
...
$this->_funcHooks['overwriteHeader'] = array('bloghasurl');
...
{
$count_2e89063a494ba04851fe8fad4a08433c = is_array($this->functionData['blog_header']) ? count($this->functionData['blog_header']) : 0;
$this->functionData['blog_header'][$count_2e89063a494ba04851fe8fad4a08433c]['blog'] = $blog;
$this->functionData['blog_header'][$count_2e89063a494ba04851fe8fad4a08433c]['cblock_control'] = $cblock_control;
$this->functionData['blog_header'][$count_2e89063a494ba04851fe8fad4a08433c]['theme_js'] = $theme_js;
$this->functionData['blog_header'][$count_2e89063a494ba04851fe8fad4a08433c]['header_js'] = $header_js;
$this->functionData['blog_header'][$count_2e89063a494ba04851fe8fad4a08433c]['title'] = $title;
$this->functionData['blog_header'][$count_2e89063a494ba04851fe8fad4a08433c]['headerButtons'] = $headerButtons;
}
...
{
$count_c016456d7344438a1208979e7c40e3c5 = is_array($this->functionData['catsAsList']) ? count($this->functionData['catsAsList']) : 0;
$this->functionData['catsAsList'][$count_c016456d7344438a1208979e7c40e3c5]['blogId'] = $blogId;
$this->functionData['catsAsList'][$count_c016456d7344438a1208979e7c40e3c5]['categories'] = $categories;
}
...
$IPBHTML .= "" . ((is_array( $categories ) && count( $categories ) && !(count($categories) == 1 && array_key_exists(0, $categories))) ? ("
	...
	".$this->__f__65e323b7e29ba2cf2835b820413f8e17($blogId,$categories)."") : ("")) . "";
return $IPBHTML;
}


function __f__65e323b7e29ba2cf2835b820413f8e17($blogId, $categories)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
$IPBHTML .= "<ul class=\"ipbmenu_content\" id='content_blocks_menucontent' style='display: none'>
	...
	") : ("")) . "" . ((is_array( $cblocks ) && count( $cblocks )) ? ("".$this->__f__882471495e71fce3a2d18a4d34aadc95($cblocks)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
function __f__882471495e71fce3a2d18a4d34aadc95($cblocks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e97903fb663068defac8b737a9612703 = is_array($this->functionData['contextSearch']) ? count($this->functionData['contextSearch']) : 0;
}
...
{
$count_69dcc62b3758561d8241f106b72447e5 = is_array($this->functionData['hookTagCloud']) ? count($this->functionData['hookTagCloud']) : 0;
$this->functionData['hookTagCloud'][$count_69dcc62b3758561d8241f106b72447e5]['tags'] = $tags;
}
$IPBHTML .= "<ul class='ipsList_inline'>".$this->__f__9c83fc4affd6236c8af92b5d6363e5ce($tags)."</ul>";
return $IPBHTML;
}


function __f__9c83fc4affd6236c8af92b5d6363e5ce($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_76acca6e3b246002944a9a9d9721a88c = is_array($this->functionData['overwriteHeader']) ? count($this->functionData['overwriteHeader']) : 0;
}
...
" . (($this->settings['blog_url']) ? ("
	<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=blog&amp;module=display&amp;section=blog&amp;blogid={$this->registry->blogFunctions->blog['blog_id']}", "public",'' ), "{$this->registry->blogFunctions->blog['blog_seo_name']}", "showblog" ) . "' title='{$this->lang->words['blog_homepage']}' id='blog_title'>
...
{
$count_2db5e778c8592f8e2cd1c9f129e3bee1 = is_array($this->functionData['short_media_tag']) ? count($this->functionData['short_media_tag']) : 0;
$this->functionData['short_media_tag'][$count_2db5e778c8592f8e2cd1c9f129e3bee1]['url'] = $url;
$this->functionData['short_media_tag'][$count_2db5e778c8592f8e2cd1c9f129e3bee1]['type'] = $type;
}
...
{
$count_1b44d99145eab01f460ff06608f666fe = is_array($this->functionData['theme_menu']) ? count($this->functionData['theme_menu']) : 0;
$this->functionData['theme_menu'][$count_1b44d99145eab01f460ff06608f666fe]['themes'] = $themes;
$this->functionData['theme_menu'][$count_1b44d99145eab01f460ff06608f666fe]['blog'] = $blog;
$this->functionData['theme_menu'][$count_1b44d99145eab01f460ff06608f666fe]['_customTheme'] = $_customTheme;
}
$IPBHTML .= "<ul class='ipbmenu_content' id='themes_menu_menucontent' style='display: none'>
	" . (($this->settings['blog_themes_custom'] OR (is_array($themes) AND count($themes))) ? ("" . (($this->settings['blog_themes_custom']) ? ("
		...
		") : ("")) . "" . ((is_array( $themes ) && count( $themes )) ? ("".$this->__f__e668b891b0eb5fa0c79e3fcc2af932a3($themes,$blog,$_customTheme)."		") : ("")) . "
...
function __f__e668b891b0eb5fa0c79e3fcc2af932a3($themes, $blog, $_customTheme='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
